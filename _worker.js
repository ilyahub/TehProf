...
<style>
  ...
  *{box-sizing:border-box}
  ...
  /* Широкая колонка “Название” + перенос */
  td.wrap-title{white-space:normal}
  ...
  <div class="table-wrap">
    <table id="tbl">
      <thead>
        ...
        <tr class="filters">
          <th data-col="id"></th>
          <th data-col="title"><input class="filter" id="fTitle" placeholder="Фильтр по"></th>
  ...
  // ==== ПИКЕР (как раньше, без изменений по UI) ====
